...
describe('usePortofolioStore', () => {
  ...
  it('modifyData applies transformations and sorting', () => {
    ...
    const repo1 = result.find(r => r.id === 688294388)!
